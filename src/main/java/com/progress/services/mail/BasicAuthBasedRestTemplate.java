package com.progress.services.mail;
 ...
 * 
 */
public class BasicAuthBasedRestTemplate extends RestTemplate {
	private HttpHeaders headers = new HttpHeaders();
	private final String username;
	private final String password;

	public BasicAuthBasedRestTemplate(String username, String password) {
		super();
