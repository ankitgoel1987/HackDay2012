...
public class MailServiceImpl implements MailService {
	...
	public void confirmBooking(BookingBean bookingData) {
		...
		form.field("html", "<p>Hi " + bookingData.getUserName() + ",<br><br>Congratulations. Your booking has been confirmed.&nbsp;Please revert with <b>Confirmation ID:"
...
//		dayBefore.add(Calendar.MINUTE, -1);
		...
		form.field("html", "<p>Hi " + bookingData.getUserName() + ",<br><br>This is a reminder mail regarding your tee booking bearing <b>Confirmation ID:"
				+ bookingData.getConfirmID() + "</b>.<br><br>We hope you would have a great time at our Golf Course.<br><br>-GolfCourse Facilities Team</p>");		
		ClientResponse postResp = webResource.type(MediaType.MULTIPART_FORM_DATA_TYPE).post(ClientResponse.class, form);
	...
	public static void main(String[] args) {
		...
		BookingBean bookingData = new BookingBean(instance,"Neela Kiran Babu","kiranbabu.neela@gmail.com@progress.com","1213213213");
